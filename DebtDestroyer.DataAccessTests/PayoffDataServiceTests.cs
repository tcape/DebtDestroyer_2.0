...
namespace DebtDestroyer.DataAccess.Tests
{
    ...
    public class PayoffDataServiceTests
    {
        ...
        private IList<Payment> _snowballDb;
        ...
        public void Init()
        {
            ...
            var customerAccounts = new List<Account>()
            {
                new Account {_AccountId = 1, _CustomerId = 1, _Name = "Wells Fargo",
                    _Balance = 1000.00m, _Apr = 0.159f, _MinPay = 25.00m, _Payment = 0.00m},
                new Account {_AccountId = 2, _CustomerId = 1, _Name = "Chase Bank",
                    _Balance = 3000.00m, _Apr = 0.189f, _MinPay = 47.00m, _Payment = 0.00m},
            ...
            var snowballPayoff = new UnitOfWork.Payoff(customer);

            //_paymentDb = customerPayoff.Generate();

            _snowballDb = snowballPayoff.GenerateSnowball();
        ...
        [TestMethod()]
        public void SnowballFindAllTest()
        {
            
            Assert.IsTrue(_snowballDb.Count().Equals(81));
        }
